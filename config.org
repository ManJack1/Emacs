...
** 待要安装的插件
- 代码补全与 LSP: copilot, copilot-chat,
- 其他: wgrep, sis, magit-todos
...
*** DONE C-l C-h 在n和v模式下设置

*** DONE dashboard 设置

*** DONE latex补全引擎设置，以及latex显示

*** DONE evil-expand

*** DONE search keymap & plugins

*** DONE auctex-config & latex-preview

*** DONE seting windows enlarge&shrink 
