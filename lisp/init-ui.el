...
(use-package dashboard
  :straight t
  :config
  (setq dashboard-startup-banner "~/.emacs.d/girl.jpg") ;; 也可以自定义图片
  (setq dashboard-image-banner-max-height 300)  ;; 最大高度 (像素)
  (setq dashboard-banner-logo-title "Welcome to Emacs Code Space!") ;; 个性签名，随读者喜好设置
